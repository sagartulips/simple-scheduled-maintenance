...
function ssm_show_maintenance_page() {
    ...
    try {
        ...
        <head>
            ...
            <title>' . esc_html($heading) . ' | Maintenance Mode</title>
            ...
            <style>
                * {
                ...
                .maintenance-page .description img {
                    max-width: 100%;
                    height: auto;
                    margin: 20px auto;
                    display: block;
                }
                .maintenance-page .description p {
                    margin: 15px 0;
                }
                /* Support alignment classes from WordPress editor */
                .maintenance-page .description .alignleft,
                .maintenance-page .description p.alignleft {
                    text-align: left;
                }
                .maintenance-page .description .aligncenter,
                .maintenance-page .description p.aligncenter {
                    text-align: center;
                }
                .maintenance-page .description .alignright,
                .maintenance-page .description p.alignright {
                    text-align: right;
                }
                .maintenance-page .description .alignjustify,
                .maintenance-page .description p.alignjustify {
                    text-align: justify;
                }
                .maintenance-page .description ul,
                .maintenance-page .description ol {
                    margin: 15px 0;
                    padding-left: 30px;
                    text-align: left;
                    display: inline-block;
                }
                .maintenance-page .description a {
                    color: #0073aa;
                    text-decoration: underline;
                }
                .maintenance-page .description a:hover {
                    color: #005177;
                }
                .countdown-container {
                    margin-top: 30px;
        ...
        <body>
            <div class="maintenance-container">
                <div class="maintenance-page">
                    <img src="' . esc_url($image) . '" alt="Maintenance">
                    <h1>' . esc_html($heading) . '</h1>
                    <div class="description">' . $desc_formatted . '</div>
                    ' . ($show_countdown ? '<div class="countdown-container">
                        <div class="countdown-title">' . esc_html($countdown_text) . '</div>
            ...
            ' . ($show_countdown ? '<script>
                (function() {
                    var endTime = ' . $countdown_end . ';
